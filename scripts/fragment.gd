...
const FISHING_SPAWN_NAME_TO_ICON := {
	...
	"Brackwater Channel":     "res://assets/icons/modifiers/fishing_r2_brackwater_channel.png",

	"Sinkhole Plunge Pool":   "res://assets/icons/modifiers/fishing_r3_sinkhole_plunge_pool.png",

	"Cascade Shelf Nets":     "res://assets/icons/modifiers/fishing_n4_cascade_shelf_nets.png",
	"Echofall Basin":         "res://assets/icons/modifiers/fishing_r4_echofall_basin.png",

	"Oxbow Bend Pool":        "res://assets/icons/modifiers/fishing_r5_oxbow_bend_pool.png",
	"Leviathan Channel":      "res://assets/icons/modifiers/fishing_h5_leviathan_channel.png",

	"Chasm Surge Run":        "res://assets/icons/modifiers/fishing_h6_chasm_surge_run.png",

	"Hanging Oasis Nets":     "res://assets/icons/modifiers/fishing_n7_hanging_oasis_nets.png",
	"Skywell Sink":           "res://assets/icons/modifiers/fishing_h7_skywell_sink.png",

	"Ice-Crack Nets":         "res://assets/icons/modifiers/fishing_n8_ice_crack_nets.png",

	"Boiling Runoff Nets":    "res://assets/icons/modifiers/fishing_n9_boiling_runoff_nets.png",
	"Geyser Cone Pool":       "res://assets/icons/modifiers/fishing_r9_geyser_cone_pool.png",
	"Steamvent Pit":          "res://assets/icons/modifiers/fishing_h9_steamvent_pit.png",

	"Abyssal Star Trench":    "res://assets/icons/modifiers/fishing_h10_abyssal_star_trench.png",
}
